        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center mb-4">
              <GraduationCap className="h-8 w-8 mr-2 text-amber-500" />
              <h2 className="text-xl font-bold">College Management System</h2>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">123 Education Ave, Academic District, 54321</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-300">info@collegemanagement.edu</span>
              </li>
            </ul>
          </div>
        </div>
